...
```{pyodide-python}
pd.merge(df_a, df_f, how="inner", on="Name")
```

You can read more about the types of joins available here: https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.merge.html
